<template>
  <div v-if="table.meta && Object.keys(table.meta).length > 0" class="global-form-footer">
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="pagination d-flex justify-content-end">
          <ul>
            <!-- First Page -->
            <li v-if="table.meta.current_page > 1" class="arrow"
              :class="table.meta.current_page == 1 ? 'disabled' : ''">
              <a href="javascript:void(0)" @click="get_datas(table.meta.current_page - 1)">
            ...
            <li class="mid-pagi">
              <template v-for="leftNum in decrement()" :key="leftNum">
                <a v-if="leftNum > 0" href="javascript:void(0)" @click="get_datas(leftNum)">
                  <span>{{ leftNum }}</span>
                </a>
              </template>
            ...
            <!-- Last Page -->
            <li v-if="table.meta.current_page < table.meta.last_page" class="arrow">
              <a href="javascript:void(0)" @click="get_datas(table.meta.current_page + 1)">
...
export default {
  ...
  methods: {
    get_datas: function (page_index) {
      ...
      let url = "admin/" + dataUrl + "?page=" + page;
