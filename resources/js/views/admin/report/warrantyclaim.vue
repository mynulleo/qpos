<template>
  <div class="container-fluid p-3 warranty-claim-report-page">
    ...
    <!-- ℹ️ Warranty Claim Report Bengali Help Info Modal -->
      ...
      <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content shadow-lg">
          <div class="modal-header bg-dark text-white py-2">
            <h5 class="modal-title fs-6 text-white"><i class="fas fa-tools me-2 text-warning"></i>ওয়ারেন্টি ও গ্যারান্টি ক্লেইম অডিট রিপোর্ট সহায়িকা</h5>
...
export default {
  ...
  methods: {
    openHelpModal() {
      ...
      if (!this.helpContent) {
        axios.get('helpInfo/WarrantyClaimReport/index').then(res => {
