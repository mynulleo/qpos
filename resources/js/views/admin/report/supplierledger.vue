        ...
        <template v-slot:search-field>
            <v-select-container title="Select Supplier" field="search_data.supplier_id" col="3">
                <v-select v-model="search_data.supplier_id" label="org_name" :reduce="(obj) => obj.id"
                    :options="suppliers" placeholder="--Select Supplier--" :closeOnSelect="true">
                </v-select>
            </v-select-container>
            ...
            <div class="my-5" id="printArea">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        ...
                        <small class="text-muted">Name: <strong>{{ datas.supplier?.org_name
                                }}</strong></small><br>
                        <small class="text-muted">Mobile: <strong>{{ datas.supplier?.mobile
                        }}</strong></small><br>
                        <small class="text-muted">Address: <strong>{{ datas.supplier?.address
                        }}</strong></small><br>
...
export default {
    data() {
        return {
            ...
            suppliers: [],  // Store account heads for the select dropdown
        };
    },
